...
- **Интеграция ИИ** - OkHttp; приоритет провайдеров OpenAI → Gemini → Anthropic; модели по умолчанию (gpt-5, gemini-2.5-flash, claude-3-7-sonnet-thinking); локальное хранение API ключей
